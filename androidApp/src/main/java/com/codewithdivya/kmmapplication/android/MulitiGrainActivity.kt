...
import com.codewithdivya.kmmapplication.GrainApi
...
class MultiGrainActivity : AppCompatActivity(), CoroutineScope {
    ...
    private fun setupRecyclerView() {
        ...
        list.apply {
            ...
            addItemDecoration(
                DividerItemDecoration(this@MultiGrainActivity, LinearLayoutManager
                .VERTICAL)
            )
        }
    }
    ...
    private fun loadList() {
        api.getGrainList(
            success = { launch(Dispatchers.Main) { grainAdapter.updateData(it) } },
            failure = ::handleError
        )
    }
